DROP FUNCTION IF EXISTS leo_model_2(zipinput char(5));
CREATE FUNCTION leo_model_2(zipinput char(5)) RETURNS void AS '
  ...
  BEGIN
	...
	INSERT INTO leo_model_2 (select
		...
		from leo_model_1 a WHERE a.zip=$1 AND a.email NOT IN (SELECT email FROM leo_model_2 WHERE a.email=leo_model_2.email)
		);

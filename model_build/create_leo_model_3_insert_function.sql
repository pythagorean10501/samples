DROP FUNCTION IF EXISTS leo_model_3(zipinput char(5));
CREATE FUNCTION leo_model_3(zipinput char(5)) RETURNS void AS '
  BEGIN
	...
	from leo_model_2 b WHERE b.zip=$1 AND b.email NOT IN (SELECT email FROM leo_model_3 WHERE b.email=leo_model_3.email)
	);

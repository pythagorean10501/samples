INSERT INTO leo_model_1 (select DISTINCT *,
    ...
    (select distinct recordid recordid2, email email2,
      ...
      (deliverable=2 AND cooking_food_grouping=1 AND age_in_two_year between 34 and 82 and state IN ('AK','AL','AR','AZ'))
      OR
      (deliverable=2 AND cooking_general=1 AND age_in_two_year between 34 and 82 and state IN ('AK','AL','AR','AZ'))
      OR
      (deliverable=2 AND cooking_gourmet=1 AND age_in_two_year between 34 and 82 and state IN ('AK','AL','AR','AZ'))
      ...
      GROUP BY email2,recordid2,Category_1,Category_2,Category_3,Category_4,Category_5,Category_6,Category_7,Category_8,
        ...
        WHERE deliverable.deliverable=2 AND deliverable.age_in_two_year between 34 and 82 and deliverable.state IN ('AK','AL','AR','AZ')
        );
